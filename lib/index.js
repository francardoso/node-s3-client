  ...
  function checkDoMoreWork() {
    ...
    function downloadS3Object() {
      ...
      function startDownload() {
        ...
        /*
        ---- Mobiliza ----
          If path of s3 be something like: /snp/5ca5aea5/55aac/file
          transform all to be on the root = ./file
        */

        var tempRootPath = fullPath.split('/');
        if (tempRootPath.length >= 8 && tempRootPath[4] === 'assets') {
          tempRootPath.splice(5, 3);
          var newFullPath = tempRootPath.join('/');
